...
def index():
    ...
    return template("Testing.tpl", message="Please enter your name")
...
def formhandler():
    bot = request.forms.get('bot')
    message = bot
    flag=True
    ##print("ROBO: My name is Robo. I will answer your queries about Chatbots. If you want to exit, type Bye!")
    #inicializador
    while(flag==True):
        user_response = request.forms.get('bot')
        ...
        if(user_response!='bye'):
            ...
            if(user_response=='thanks' or user_response=='thank you' ):
                ...
                if(greeting(user_response)!=None):
                        ...
                        bot=response(user_response)
                        sent_tokens.remove(user_response)
    else:
        flag=False
        #fin
        bot="ROBO: Bye! take care.."


    return template("Testing.tpl", message=message)
